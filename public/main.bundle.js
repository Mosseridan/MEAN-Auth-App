...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__components_pagenotfound_pagenotfound_component__ = __webpack_require__("../../../../../src/app/components/pagenotfound/pagenotfound.component.ts");
...
var LoginComponent = (function () {
    ...
    LoginComponent.prototype.onLoginSubmit = function () {
        ...
        // Validate Fields
        var valid = this.validateService.validateLogin(user);
        if (!valid.success) {
...
var RegisterComponent = (function () {
    ...
    RegisterComponent.prototype.onRegisterSubmit = function () {
        ...
        // Validate Fields
        var valid = this.validateService.validateRegister(user);
        if (!valid.success) {
            this.flashMessage.show(valid.msg, { cssClass: 'alert-danger', timeout: 5000 });
            return false;
        }
